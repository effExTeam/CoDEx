...
InstallCoDEx::notcomp="Your Mathematica version is older than 8. Installation aborted!";
...
(* ::Input::Initialization:: *)
Options[InstallCoDEx]={AutoDisableInsufficientVersionWarning->None,AutoOverwriteCoDExDirectory->None,CoDExDevelopmentVersionLink->"https://github.com/sunandopatra/CoDEx-0.0/raw/master/CoDEx.zip",CoDExStableVersionLink->"https://github.com/sunandopatra/CoDEx-0.0/raw/master/CoDEx.zip",InstallCoDExDevelopmentVersion->False,InstallCoDExTo->FileNameJoin[{$UserBaseDirectory,"Applications","CoDEx"}]};
...
If[$VersionNumber<8,Message[InstallCoDEx::notcomp];
Abort[]];
If[$VersionNumber==8,

(*To use FetchURL in MMA8 we need to load URLTools first*)
CDGetUrl[x_]:=Utilities`URLTools`FetchURL[x],
